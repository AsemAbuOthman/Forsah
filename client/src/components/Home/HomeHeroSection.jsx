    ...
    return (  
        <>
            ...
            <div className=" flex justify-center  items-center flex-col md:flex-row md:flex-nowrap md:py-35 py-5 max-w-400 md:gap-20 flex-wrap ">
                ...
                <div className="text-white flex items-start justify-center gap-15  max-w-200 p-8 flex-col bg-gradient-to-br from-[#fc1d1dda] via-violet-600/95 to-amber-400 rounded-xl">
                ...
                <div className="grid md:grid-cols-2 grid-cols-3 justify-center items-center justify-items-center gap-10 w-[80%]">
                    <video
                        autoPlay
                        loop
                        muted
