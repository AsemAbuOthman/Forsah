    ...
    return (
        <> 
            <nav className="md:flex items-start justify-center  starting:-translate-x-60 transition duration-500 ease-in-out z-100 h-140 w-fit m-0 py-5 mt-10 fixed ">
                ...
                <div className="hidden  bg-gradient-to-tr from-[#ff0000] via-violet-400 to-amber-500  w-fit h-full md:flex justify-around flex-wrap overflow-auto gap-10   py-6 px-8 rounded-2xl">
