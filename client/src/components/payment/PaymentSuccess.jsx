...
const PaymentSuccess = ({ orderData, paymentDetails, billUrl, proposal, project }) => {
      ...
      <div className="bg-gray-50 px-6 py-4">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3">
            ...
            <button
              type="button"
              className="inline-flex justify-center items-center rounded-md border border-transparent bg-yellow-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
