...
<div className="flex items-center gap-3 mb-6">
    <div className="flex items-center justify-center w-8 h-8 rounded-full bg-gradient-to-r from-violet-400 to-yellow-400 text-white font-medium">
    {step}
    </div>
        ...
        <FormSection>
            ...
            <FormField label="Email" error={errors.email}>
                ...
                <input
                    ...
                    className={`pl-10 w-full rounded-lg border ${errors.email ? 'border-red-500' : 'border-gray-300'} px-3 py-2.5 focus:ring-2 focus:ring-violet-200 focus:border-violet-400`}
            ...
            <FormField label="Password" error={errors.password}>
                ...
                <input
                    ...
                    onChange={handleChange}
                    className={`pl-10 pr-10 w-full rounded-lg border ${errors.password ? 'border-red-500' : 'border-gray-300'} px-3 py-2.5 focus:ring-2 focus:ring-violet-200 focus:border-violet-400`}
            ...
            <FormField label="Confirm Password" error={errors.confirmPassword}>
                ...
                <input
                    ...
                    onChange={handleChange}
                    className={`pl-10 pr-10 w-full rounded-lg border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'} px-3 py-2.5 focus:ring-2 focus:ring-violet-200 focus:border-violet-400`}
        ...
        <FormSection>
            ...
            <FormField label="Username" error={errors.username}>
                ...
                <input
                    ...
                    onChange={handleChange}
                    className={`pl-10 w-full rounded-lg border ${errors.username ? 'border-red-500' : 'border-gray-300'} px-3 py-2.5 focus:ring-2 focus:ring-violet-200 focus:border-violet-400`}
            ...
            <FormField label="Role">
                ...
                {roles.map((role) => (
                    ...
                    className={`cursor-pointer border rounded-xl p-4 transition-all ${
                        ...
                        ? 'bg-gradient-to-br from-violet-50 to-yellow-50 border-violet-300 shadow-sm' 
                        : 'bg-white border-gray-200 hover:bg-gray-50'
                    }`}
                    onClick={() => setFormData(prev => ({ ...prev, roleId: role.value as number }))}
                    >
                    <div className={`font-medium ${
                        formData.roleId === role.value ? 'text-violet-600' : 'text-gray-700'
                    }`}>
                        {role.label}
                    </div>
        ...
        <FormSection>
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <input
                    ...
                    onChange={handleChange}
                    className="w-full rounded-lg border-gray-300 px-3 py-2.5 focus:ring-2 focus:ring-violet-200 focus:border-violet-400"
        ...
        <FormSection>
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <input
                    ...
                    onChange={handleChange}
                    className={`w-full rounded-lg border ${errors.zipCode ? 'border-red-500' : 'border-gray-300'} px-3 py-2.5 focus:ring-2 focus:ring-violet-200 focus:border-violet-400`}
            ...
            <FormField label="Phone" optional>
                ...
                inputClass="!w-full !h-[44px] !py-2 !border-gray-300 !rounded-lg focus:!border-violet-400 focus:!ring-2 focus:!ring-violet-200"
        ...
        <FormSection>
            ...
            <FormField label="Date of Birth" error={errors.dateOfBirth}>
                ...
                <input
                    ...
                    onChange={handleChange}
                    max={minDateStr}
                    className={`w-full pl-10 rounded-lg border ${errors.dateOfBirth ? 'border-red-500' : 'border-gray-300'} px-3 py-2.5 focus:ring-2 focus:ring-violet-200 focus:border-violet-400`}
                />
                </div>
    ...
    case 8:
        ...
        <FormSection>
            ...
            <FormField label="Professional Title" error={errors.professionalTitle}>
                ...
                onChange={handleChange}
                className={`w-full rounded-lg border ${errors.professionalTitle ? 'border-red-500' : 'border-gray-300'} px-3 py-2.5 focus:ring-2 focus:ring-violet-200 focus:border-violet-400`}
            ...
            <FormField label="Hourly Rate ($)" error={errors.hourlyRate}>
                ...
                <input
                    ...
                    onChange={handleChange}
                    className={`w-full pl-10 rounded-lg border ${errors.hourlyRate ? 'border-red-500' : 'border-gray-300'} px-3 py-2.5 focus:ring-2 focus:ring-violet-200 focus:border-violet-400`}
            ...
            <FormField label="About Me" error={errors.profileDescription}>
                ...
                onChange={handleChange}
                rows={5}
                className={`w-full rounded-lg border ${errors.profileDescription ? 'border-red-500' : 'border-gray-300'} px-3 py-2.5 focus:ring-2 focus:ring-violet-200 focus:border-violet-400`}
                ...
                <div className="space-y-4 text-gray-700">
                    ...
                    <div className="col-span-2">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                            ...
                            <span key={interest.value} className="inline-block px-2.5 py-1 bg-violet-100 text-violet-800 rounded-full text-xs font-medium">
                                {interest.label}
                            </span>
                            ))}
                        </div>
...
return (
    ...
    <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8">
            ...
            <div className="w-20 h-20 rounded-full bg-gradient-to-r from-violet-400 to-yellow-400 flex items-center justify-center shadow-lg">
        ...
        <div className="mb-8">
            ...
            <span className="text-sm font-medium text-violet-600">{Math.round((step / totalSteps) * 100)}% Complete</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
            <div 
                className="bg-gradient-to-r from-violet-400 to-yellow-400 h-2 rounded-full transition-all duration-500 ease-out" 
        ...
        <form onSubmit={step === totalSteps ? handleSubmit : (e) => e.preventDefault()}>
            ...
            <div className="flex gap-3">
                ...
                <button
                    type="button"
                    onClick={skipStep}
                    className="px-6 py-3 border border-violet-300 rounded-xl bg-white text-violet-600 hover:bg-violet-50 transition-all shadow-sm hover:shadow-md"
                >
                    Skip
                </button>
                )}
                ...
                <button
                    type="button"
                    onClick={nextStep}
                    className="flex items-center px-6 py-3 bg-gradient-to-r from-violet-500 to-yellow-500 rounded-xl text-white hover:from-violet-600 hover:to-yellow-600 transition-all shadow-lg hover:shadow-xl"
                >
                    Continue
                ...
                <button
                    type="submit"
                    disabled={isLoading}
                    className="flex items-center px-8 py-3.5 bg-gradient-to-r from-violet-500 to-yellow-500 text-white font-semibold rounded-xl shadow-xl hover:from-violet-600 hover:to-yellow-600 disabled:opacity-70 disabled:cursor-not-allowed transition-all"
                >
                    {isLoading ? (
