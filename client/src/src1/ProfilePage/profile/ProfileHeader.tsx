  ...
  const mutation = useMutation({
    mutationFn: (file: File) => {
      ...
      return new Promise<string>((resolve) => {
        ...
        return updateUserProfile(user.id, { avatar: avatarUrl });
      });
    },
    onSuccess: () => {
            ...
            <div className="mt-4 md:mt-0">
              <div className="flex items-center">
                <div className="flex items-center">
                  ...
                  <span className="ml-1 text-gray-700 font-medium">{user.rating}</span>
                </div>
                <span className="mx-2 text-gray-400">|</span>
                <span className="text-gray-700"><span className="font-medium">{user.completedProjects}</span> Projects</span>
                <Button 
                    size="icon"
                    variant="ghost"
