...
export default function ReviewsSection({ reviews, onViewAllReviews, isEditable }: ReviewsSectionProps) {
  ...
  const renderStars = (rating: string) => {
    ...
    return (
      <div className="flex text-yellow-400 mb-4 ml-80 ">
            ...
            >
              <div className="flex items-center mb-2">
                <img 
                  ...
                  alt={review.receiverId} 
                  className="w-18 h-18 rounded-full mr-5 object-cover" 
                />
                <div>
                  <div className="font-medium text-gray-800">{review.firstName + ' ' + review.lastName} </div>
                  <div className="text-xs text-gray-800">{' @' + review.username}</div>
